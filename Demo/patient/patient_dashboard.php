...
//query for counselling history

$sql = "
    SELECT appointment_date, appointment_time, doctor_name, department_name, patient_status
    FROM appointments
    WHERE email = ? AND department_name LIKE '%Clinic%'  -- Assuming counseling appointments are in clinics with 'Clinic' in the name
...
$stmt->close();
// Query for total sessions (completed sessions)
